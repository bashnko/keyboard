...
// Fallbacks: if RGB features are not enabled, make RGB keycodes no-ops
#ifndef RGB_MOD
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    // Your existing SWITCH_FN handling
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_CAPS, LT(3, KC_A), LSFT_T(KC_S), LCTL_T(KC_D), LT(1, KC_F), KC_G, KC_H, LT(4, KC_J), RCTL_T(KC_K), RSFT_T(KC_L), KC_SCLN, KC_QUOT, KC_ENT, KC_PGUP,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN,
        KC_LCTL, KC_LGUI, _______, MT(MOD_LALT, KC_SPC), KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT
    ),
