...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GRAPHITE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, LT(6, KC_SPC), KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_QWERTY] = LAYOUT(
        ...
        CAPS_CTRL_SPACE, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, KC_PGUP,
    ...
    [_SYMBOLS_RIGHT] = LAYOUT(
        ...
        _______, KC_A, KC_S, LCTL_T(KC_D), LT(1, KC_F), KC_G, KC_EQL, KC_LPRN, KC_RPRN, KC_COLN, KC_DQT, KC_SCLN, KC_ENT, KC_PGUP,
    ...
    [_SYMBOLS_LEFT] = LAYOUT(
        ...
        KC_LSFT, KC_BSLS,   KC_CIRC, KC_UNDS, KC_TILD, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP, KC_PGDN,
    ...
    [_NAV] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_MUTE,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL,
        CAPS_CTRL_SPACE, KC_A, KC_S, KC_D, KC_F, KC_G, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN, KC_QUOT, KC_ENT, KC_PGUP,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN,
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RGHT
    ),
